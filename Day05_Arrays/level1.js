...
// 18
const lastThreeCompanies = itCompanies.slice(itCompanies.length-3,itCompanies.length)
// ['Facebook', 'Apple', 'Amazon']
// 19
const middleCompanySlice = itCompanies.slice(parseInt(itCompanies.length/2),Math.ceil(itCompanies.length/2))
// ['Google']
// 20
